<x-app-layout>
    <div class="max-w-4xl">
        <h1 class="mb-8 text-3xl font-bold text-slate-900">
            Import Service Reports from Excel
        </h1>
        ...
        <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            <form
                action="{{ route('correctives.import.preview-action') }}"
                method="POST"
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-500">
                        Expected columns: Tanggal Laporan, Jam Laporan, Jam Visit, Time Response, Service Report Type, Ruangan, Nama Alat, Merk, Type, Serial Number, Tanggal Instal, Distributor, Pemeriksaan, Problem, Solution, Sparepart, Jumlah Sparepart, Keterangan, Hasil Pemeriksaan, Teknisi, User.
                    </p>
                </div>
