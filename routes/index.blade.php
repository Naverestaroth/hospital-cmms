    ...
    <div class="space-y-6">
        <div>
            ...
            <p class="mt-2 text-slate-500">
                List of all technicians and their activities.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <!-- Technician Card 1: Andi Pratama -->
            <div class="ds-card">
                <div class="ds-card-body items-center text-center">
                    <div class="ds-avatar">
                        <div class="w-24 rounded-full bg-slate-200">
                    ...
                    <div class="ds-card-actions mt-6 w-full">
                        <a href="{{ route('technicians.show', ['id' => 1]) }}" class="ds-btn ds-btn-primary w-full">View Workspace</a>
                    </div>
                </div>
            </div>

            <!-- Technician Card 2: Budi Santoso -->
            <div class="ds-card">
                <div class="ds-card-body items-center text-center">
                    <div class="ds-avatar">
                        <div class="w-24 rounded-full bg-slate-200">
                    ...
                    <div class="ds-card-actions mt-6 w-full">
                        {{-- This link can point to the same prototype page for now --}}
                        <a href="{{ route('technicians.show', ['id' => 2]) }}" class="ds-btn ds-btn-primary w-full">View Workspace</a>
                    </div>
                </div>
            </div>
